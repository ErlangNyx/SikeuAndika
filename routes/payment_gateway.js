...
var configServerKey = "Isi Sesuai key pada akun Midtrans";
var configClientKey = "Isi Sesuai key pada akun Midtrans";
//membuat objek snap
...
router.get("/status/:id", function (req, res, next) {
  ...
  if (dataBilling.transaction_status != "Terbayar") {
    ...
    //proses insert transaksi dan transaksi_detail
    //menggunakan metode transaction
    koneksi.transaction().then(function (t) {
      Transaksi.create(dataTrans, { transaction: t })
        .then((data) => {
